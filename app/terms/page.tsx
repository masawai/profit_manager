export default async function Terms() {
  return (
    <div className="max-w-4xl mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-4">利用規約</h1>
      <p className="mb-4">
        この利用規約（以下、「本規約」といいます。）は、Profit
        Manager（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
      </p>
      <h2 className="text-2xl font-semibold mb-2">第 1 条（適用）</h2>
      ...
      <h2 className="text-2xl font-semibold mb-2">第 2 条（利用登録）</h2>
      <ol className="list-decimal pl-4 mb-4">
        <li className="mb-2">
      ...
      <h2 className="text-2xl font-semibold mb-2">第 5 条（禁止事項）</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">第 8 条（退会）</h2>
      <p className="mb-4">
